...
object Constants {
    ...
    const val PREF_EXOPLAYER_RESTRICT_TRANSCODING_TO_MP4 = "pref_exoplayer_restrict_transcoding_to_mp4"
    const val PREF_EXOPLAYER_RESTRICT_TRANSCODING_TO_MKV = "pref_exoplayer_restrict_transcoding_to_mkv"
